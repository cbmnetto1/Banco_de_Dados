...
const Patrocinador = require('./tabelas/Patrocinador'); // Importa a classe
const Show = require('./tabelas/Show');
const Convenio = require('./tabelas/Convenio');
const Ingrediente = require('./tabelas/Ingrediente');
